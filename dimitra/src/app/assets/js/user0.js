...
// document.getElementById("graph").setAttribute("data-percent","30")
// drawCircle('#efefef', options.lineWidth, 100 / 100);
// drawCircle('#555555', options.lineWidth, options.percent / 100);

// MAKE A WAY FOR options.percent TO BE READ AND APPLIED PROPERLY
// START MAKING THE JSON STRUCTURE