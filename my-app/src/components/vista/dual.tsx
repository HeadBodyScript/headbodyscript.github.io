...
const fetcher = async () => {
    ...
    if (display) {
      display.innerHTML = `
        <div>
          <div class='w-4/4 h-auto md:w-90 md:h-auto aspect-square md:rounded-lg' style="background-image: ${item.url ?? "0"}; background-size: cover; background-position: center;"></div>
          <div class='p-4'>
