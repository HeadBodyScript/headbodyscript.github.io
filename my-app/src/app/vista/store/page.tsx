...
import DisplayStore from "@/components/vista/store"
      ...
      <div className='center text-black'>
        ...
        <section className='w-full md:w-full sm:w-full px-2 py-4'>
          <div className="bg-white rounded-lg shadow p-4 h-fit">
            ...
            <div className="bg-white rounded-lg shadow p-2 column h-fit mt-4 mb-4">
              <div className="row grid gap-2">
                <div className="active row rounded-lg shadow p-2 text-gray-500 hover:bg-gray-200 hover:text-gray-800">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-eye-slash-fill" viewBox="0 0 16 16">
                    <path d="m10.79 12.912-1.614-1.615a3.5 3.5 0 0 1-4.474-4.474l-2.06-2.06C.938 6.278 0 8 0 8s3 5.5 8 5.5a7 7 0 0 0 2.79-.588M5.21 3.088A7 7 0 0 1 8 2.5c5 0 8 5.5 8 5.5s-.939 1.721-2.641 3.238l-2.062-2.062a3.5 3.5 0 0 0-4.474-4.474z"/>
                    <path d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829zm4.95.708-2.829-2.83a2.5 2.5 0 0 1 2.829 2.829zm3.171 6-12-12 .708-.708 12 12z"/>
                  </svg>
                ...
                <div className="row rounded-lg shadow p-2 text-gray-500 hover:bg-gray-200 hover:text-gray-800">
                  ...
                  <div className='ml-2'>Lootboxes</div>
                </div>
              </div>
            </div>            
            <div className="grid grid-cols-4 gap-4">
              ...
              item.map((item: any) => (
                <div key={item.id} className='h-full'>
                  <DisplayStore userCookie={userCookie}>
                    <data value={item.uid}></data>
                    <div
                    ...
                    <div className='w-full p-1'>
                      <div className='shadow rounded-lg p-3 hover:bg-neutral-200'>Unlock for <strong>{item.currency ?? 50}</strong> gold</div>
                    </div>
                  </DisplayStore>
                </div>
              ))}
