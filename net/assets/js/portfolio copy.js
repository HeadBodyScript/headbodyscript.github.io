    ...
    <div class="card">
      <div class="card-container">
          <ul>
              ...
              <li class="border"><i class="bi bi-dot"></i>${GitHub.description}</li>
              <li class="border"><i class="bi bi-caret-right-fill"></i>ReadMe.MD</li>
              <li class="border readme scrollbar"><i class="bi bi-dot"></i>
              <pre>${README}</pre>
              </li>
              ...
              <li class="border"><i class="bi bi-link"></i><a style="color: blueviolet;" class="link" href="https://github.com/${userGitHub}/${GitHub.repository}">Visit the repository</a></li>
          </ul>
      </div>
    </div>
    `
