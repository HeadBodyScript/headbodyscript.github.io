...
<script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);} gtag('js', new Date());gtag('config', 'G-2BCEYTZM4F');</script>
`
...
<div class="wrapper">
        <ul class="justify-content-between">
          ...
          <li>
            <a class="column" href="https://headbodyscript.nl/user-login">
