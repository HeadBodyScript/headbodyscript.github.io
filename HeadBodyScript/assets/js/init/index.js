...
const serverStatus = document.getElementById("serverStatus"),
  ...
  serverMax = document.getElementById("serverMax"),
  serverOnline = document.getElementById("serverOnline"),
...
let getServer = () => {
  ...
  fetch("https://eu.mc-api.net/v3/server/ping/mc.hypixel.net", {
    ...
    console.log(e),
    serverStatus.innerHTML = e.online,
    serverMax.innerHTML = e.players.max,
    serverOnline.innerHTML = e.players.online,
    serverVersion.innerHTML = e.version.name,
    serverMOTD.innerHTML = e.description.replace("§a", "")
